            ...
            return (
                <div className="col col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    <div className="jumbotron nodes">
                        ...
                        <h5>Showing top 20 (ranked by node agreement)</h5>
                        <hr style={{
                        ...
                        <table className="table">
                            ...
                            <tbody>
                                {top_20_txs.map((item, i) =>
                                    <tr key={i}>
                                        <td className="tx_td"><a href={'/unconfirmedtxinfo/' + item.connection_id + '/' + item.tx.substring(2)}>{item.tx.substring(2)}</a></td><td className="node_td">{item.node_count}</td>
                                    </tr>
                                )}
                            </tbody></table>
