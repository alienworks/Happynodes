...
class AddressTxs extends Component {
    render() {
        const { addresstxs } = this.props;

        if (addresstxs.pending) {
            return (
        ...
        } else if (addresstxs.fulfilled) {
            let data = addresstxs.value;
            ...
            return (
                    ...
                    <div className="jumbotron nodes">
                        ...
                        <h2>Address Last {data.total_entries > 15 ? 15 : data.total_entries} Transactions</h2>
                        <hr/>
...
export default connect((props) => ({
    addresstxs: {
        url: "https://api.neoscan.io/api/main_net/v1/get_address_abstracts".concat(`/${props.addr}/1`),
